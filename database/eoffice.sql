...
(
    ...
    `module`    varchar(50) NULL DEFAULT NULL COMMENT '模块',
    `ckey`      varchar(50) NULL DEFAULT NULL COMMENT '配置key',
    `cvalue`    text        NULL DEFAULT NULL COMMENT '配置value',
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '内容存储'
  ROW_FORMAT = Compact;
...
(
    ...
    `cid`       bigint(20) UNSIGNED NULL DEFAULT NULL COMMENT '分类ID',
    `title`     varchar(255)        NULL DEFAULT '' COMMENT '模板名称',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '文档模板'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `create_at` datetime(0)         NULL DEFAULT NULL COMMENT '创建时间',
    `update_at` datetime(0)         NULL DEFAULT NULL COMMENT '更新时间',
    `extension` varchar(255)        NULL DEFAULT '' COMMENT '支持的文件类型 逗号 『,』 分割',
    PRIMARY KEY (`cid`) USING BTREE
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '模板分类表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `update_at` datetime(0)         NULL DEFAULT NULL,
    `update_by` bigint(20)          NULL DEFAULT NULL,
    `extra_id`  varchar(36)         NULL DEFAULT '' COMMENT '外部系统的ID',
    PRIMARY KEY (`gid`) USING BTREE
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '分组'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '资源权限'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '资源（文件）'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '文档 附件表'
  ROW_FORMAT = Compact;
...
(
    ...
    `url`       varchar(255)        NULL DEFAULT NULL COMMENT '访问地址',
    `auth_code` varchar(10)         NULL DEFAULT '' COMMENT '授权码， 空表示不需要授权码',
    `endtime`   datetime(0)         NULL DEFAULT NULL COMMENT '截止日期， 0000-00-00 00:00:00 表示永久有效',
    `create_at` datetime(0)         NULL DEFAULT NULL,
    `update_at` datetime(0)         NULL DEFAULT NULL,
    `create_by` bigint(20)          NULL DEFAULT NULL,
    `update_by` bigint(20)          NULL DEFAULT NULL,
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '分享范围'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `container`   varchar(255) NULL DEFAULT 'root',
    `active_rule` varchar(255) NULL DEFAULT NULL,
    `create_at`   datetime(0)  NULL DEFAULT NULL,
    `create_by`   bigint(20)   NULL DEFAULT NULL,
    `update_at`   datetime(0)  NULL DEFAULT NULL,
    `update_by`   bigint(20)   NULL DEFAULT NULL,
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '乾坤子应用'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `update_by` bigint(20) UNSIGNED NULL     DEFAULT NULL COMMENT '更新人ID',
    `auth_type` varchar(30)         NULL     DEFAULT '' COMMENT '认证方式',
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '用户分组关系表'
  ROW_FORMAT = Dynamic;
